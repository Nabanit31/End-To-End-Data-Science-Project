...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            preprocessor = ColumnTransformer([
                ("num_pipeline",num_pipelie,numerical_columns),
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            nummerical_columns = ['writing_score','reading_score']
            ...
            input_feature_train_arr = preprocessing_obj.transform(imput_features_train_df)
